...
// node_modules/@gravity-ui/chartkit/build/docs. Runs at the end of the build via the gulp
// `copy-docs` task (and `npm run build:docs`). Uses @gravity-ui/readme-validator's
